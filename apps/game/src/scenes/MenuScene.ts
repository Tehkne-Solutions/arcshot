...
export class MenuScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    this.add.text(806, 372, "NPC tático, vento extremo e vida ampliada. Disponível desde o início.", { fontFamily: "Lexend", fontSize: "14px", color: "#d1aedb", wordWrap: { width: 320 } });
    ...
    this.add.text(806, 512, "Servidor base pronto. Duelo online entra após o balanceamento do modo desafio.", { fontFamily: "Lexend", fontSize: "14px", color: "#7188a3", wordWrap: { width: 320 } });
